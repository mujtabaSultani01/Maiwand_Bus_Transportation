  ...
  <div class="row">
          <div class="col-lg-12">
            <section class="panel"> 
              <header class="panel-heading">
                <h1> <strong>Home page arrangement</strong></h1>
               </header>
        ...
        <div class="row">
          <div class=>
            <section class="panel">
              <header class="panel-heading">
             <h1> <strong> Home page data</strong></h1>
              </header>
                ...
                @foreach($save as $d)                  
                  <tr>
                    ...
                    <td><img src="link/images/{{$d->image}}" width='100' height='100'></td>
                     <td> 
                       <a href="homeform/{{$d->id}}/edit " class="btn btn-primary" type="submit" >upade</a>
                    </td>
                    <td>
                           <form method="post" action="homeform/{{$d->id}} ">
                            {{csrf_field()}}
                            {{method_field("DELETE")}}
